...
| **PDF Attachments**                 | Implemented | Upload, preview, and download functional     |
| **Two-Factor Authentication (2FA)** | Implemented | **Out of live walkthrough**                  |
| **OCR Extraction**                  | Future Work | Part of research vision, not in portal scope |
| **Scraping Pipelines**              | Future Work | Part of research vision, not in portal scope |
| **Live External Ingestion**         | Future Work | Part of research vision, not in portal scope |
...
The current portal focuses on the **user-facing platform** and **administrative governance**. Advanced data processing features such as **OCR extraction**, **automated scraping**, and **live ingestion** from external government sources are classified as **Future Work** and are part of the broader research vision rather than the current website implementation.
